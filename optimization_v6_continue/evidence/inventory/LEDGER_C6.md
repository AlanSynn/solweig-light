...
| C6-81 reopened selection | **SELECTED (C6-81r)** — R04+G06 patch-classification exact tables + CONDITIONAL cylinder-channel decode fix (must beat declined C6-50 evidence under same protocol); G05/R09/S01/S04/S05 not selected (evidence/selection/C6-81r_selection_reopened.md); implementation pending review + dispatch |
