> v4 scheduling policy: read `VALIDATION_POLICY.md` before experiments. Numerical derivations and conditional examples below remain inherited analysis, not new measurements. Develop at 128/256 scale; one frozen final-scale batch, no routine large matrix.
...
Reproduce:
    ...
    python optimization_v4/tools/throughput_model.py --output optimization_v4/evidence/throughput_scenarios.json
